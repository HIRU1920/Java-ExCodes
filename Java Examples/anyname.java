...
for(l=1;l<=i;l++)
 ...
 static void crossbl()//same bottom triangle (left)
{
for(j=1;j<=i;j++)
	{
		System.out.printf(" ");
...
for(l=1;l<=5;l++)
 ...
 static void midh()  //middle part os H
{
for(l=1;l<=5;l++)
	{
		if(i>4 && i<7)
 ...
 static void spj()// creates J
{
 ...
 static void midk()  //middle part of K
{
for(l=0;l<=6;l++)
	{
		if(l==count)
...
System.out.println("\n\n----------------------------------------------\n Thank You for using Hir's Code \n");
anyname.main(args);//calling main function
}
}